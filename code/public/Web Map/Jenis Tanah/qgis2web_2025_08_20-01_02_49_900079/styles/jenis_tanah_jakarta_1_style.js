var size = 0;
var placement = 'point';
function categories_jenis_tanah_jakarta_1(feature, value, size, resolution, labelText,
                       labelFont, labelFill, bufferColor, bufferWidth,
                       placement) {
                var valueStr = (value !== null && value !== undefined) ? value.toString() : 'default';
                switch(valueStr) {case 'Jd':
...
var style_jenis_tanah_jakarta_1 = function(feature, resolution){
    var context = {
        feature: feature,
        variables: {}
    };
    ...
    var style = categories_jenis_tanah_jakarta_1(feature, value, size, resolution, labelText,
